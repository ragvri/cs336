...
def run_get_batch(
    ...
    """
    return load_data(x=dataset, batch_size=batch_size, context_len=context_length, device=device)
    ...
    Returns:
        tuple[dict[int, bytes], list[tuple[bytes, bytes]]]:
            ...
            merges:
                ...
                Merges are ordered by order of creation.
    """
    bpe_trainer = OptimizedBPETrainer(
...
def main():
    # Example usage of run_train_bpe
    file_path = "/home/rjindal/local_code/cs336-stanford/assignment1-basics/data/TinyStoriesV2-GPT4-valid.txt"
    max_vocab_size = 1_000
    special_tokens = ["<|endoftext|>"]
    start_time = time.time()
    vocab, merges = run_train_bpe(file_path, max_vocab_size, special_tokens=special_tokens)
    end_time = time.time()
